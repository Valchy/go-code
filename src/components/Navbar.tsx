		...
		<section className="relative w-full px-8 text-gray-700 bg-white body-font">
			<div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
				...
				<nav className="top-0 left-0 z-0 flex items-center justify-center w-full h-full py-5 -ml-0 space-x-5 text-base md:-ml-5 md:py-0 md:absolute">
					<a href="/code-snippets" className="relative font-medium leading-6 text-gray-600 hover:text-gray-900 hover:underline">
						<span className="block">All Snippets</span>
					</a>
					<a href="/create" className="relative font-medium leading-6 text-gray-600 hover:text-gray-900 hover:underline">
						<span className="block">Create Your Own</span>
					</a>
					<a
						href="https://valerisabev.com"
						className="relative font-medium leading-6 text-gray-600 hover:text-gray-900 hover:underline"
					>
